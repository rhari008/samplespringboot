...
//	@Value("${vcap.services.sample_saas_service.credentials.uaa.xsappname}")
//	private String xsappnameService;
//	
	// This Endpoint is called when a new tenant subscribes to the application
		...
		public String callbackPut(@PathVariable(value = "tenantID") String tenantID, @RequestBody PayloadDataDto payload)
			...
			return "https://" + payload.getSubscribedSubdomain() + "-ar-sample-app.cfapps.eu10.hana.ondemand.com";
		}
